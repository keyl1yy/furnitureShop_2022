...
import urlImg1 from '../../public/img/img_home1.jpeg'
import urlImg2 from '../../public/img/img_home2.jpeg'
import { useSelector } from 'react-redux'
import { useGetAllProduct } from '../../hooks/products/productHook'
import missionUrl from '../../public/icon/mission.svg'
import visionUrl from '../../public/icon/vision.svg'
import historyUrl from '../../public/icon/history.svg'
import { useDispatch } from 'react-redux'
import { sendMailDiscount } from '../../redux/features/discountSlice'
...
const Home = () => {
    ...
    const handleSubmit =(e) => {
        e.preventDefault();
        if(email !== ""){
            dispatch(sendMailDiscount(email));
        }
    }
    //! Effect
    useEffect(() => {
        if(discountState.statusCode === 400){
            toastTify('error', discountState.msg);
            setEmail("");
        }
        if(discountState.statusCode === 200){
            setEmail("");
        }
    },[
        discountState.statusCode
    ])
        ...
        <>
            ...
            <section className='section-center home-title'>
                ...
                <article className='img-container'>
                    <img src={urlImg1} alt='demo-img' className='main-img'/>
                    <img src={urlImg2} alt='demo-img-1' className='accent-img'/>
                </article>
            </section>
                ...
                <div className='section-center'>
                    ...
                    <div className='services-center'>
                        <article className='service'>
                            <span className='icon'>
                                <img src={missionUrl} alt="mission"/>
                        ...
                        <article className='service'>
                            <span className='icon'>
                                <img src={historyUrl} alt="history"/>
                ...
                <div className='section-center'>
                    ...
                    <div className='content'>
                        ...
                        <form className='contact-form' onSubmit={(e) => handleSubmit(e)}>
                            <input type='email' className='form-input' value={email} placeholder='enter email' onChange={(e) => setEmail(e.target.value)}/>
                            {!discountState.isLoading ? 
                            <button type='submit' className='submit-btn'>subscribe</button> 
                            : 
                            <LoadingButton loading variant='contained' className='submit-btn' sx={{backgroundColor: '#decbc0'}}>subscribe</LoadingButton>}
                        </form>
                    </div>
                </div>
            </section>
